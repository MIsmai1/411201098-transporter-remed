...
class PengirimanController extends Controller
{
    ...
    public function createPengiriman(Request $request)
    {
        ...
        return Helper::toJson($pengiriman, "Data berhasil ditambahkan");
    ...
    public function updatePengiriman(Request $request)
    {
        ...
        return Helper::toJson($pengiriman, "Data berhasil diubah");
    ...
    public function approvePengiriman(Request $request)
    {
        ...
        return Helper::toJson($pengiriman, "Pengiriman telah di approve");
